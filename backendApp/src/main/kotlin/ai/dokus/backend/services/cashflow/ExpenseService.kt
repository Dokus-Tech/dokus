package ai.dokus.backend.services.cashflow
...
class ExpenseService(
    ...
    suspend fun getExpense(
        ...
        logger.debug("Fetching expense: $expenseId for tenant: $tenantId")
    ...
    suspend fun listExpenses(
        ...
        logger.debug("Listing expenses for tenant: $tenantId (category=$category, limit=$limit, offset=$offset)")
