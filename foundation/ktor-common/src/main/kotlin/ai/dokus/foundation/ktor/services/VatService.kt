...
interface VatService {
     ...
     */
    suspend fun createReturn(tenantId: TenantId, year: Int, quarter: Int): VatReturnDto
     ...
     */
    suspend fun findByQuarter(tenantId: TenantId, year: Int, quarter: Int): VatReturnDto?
     ...
     */
    suspend fun listUnpaid(tenantId: TenantId): List<VatReturnDto>
