...
interface BankService {
     ...
     */
    suspend fun listConnections(tenantId: TenantId, activeOnly: Boolean = true): List<BankConnectionDto>
     ...
     */
    suspend fun listUnreconciled(tenantId: TenantId): List<BankTransactionDto>
