...
internal const val MemoryCacheSizePercent = 0.25
internal const val DiskCacheMaxSizeBytes = 256L * 1024 * 1024 // 256 MB

/**
 * Koin module that registers the authenticated [ImageLoader] as a singleton.
 * Platform-specific: Android uses `androidContext()`, others use `PlatformContext.INSTANCE`.
 */
expect val imageLoaderModule: Module
...
internal fun createAuthenticatedImageLoader(
