...
object ExpenseMapper {
    ...
    fun ResultRow.toExpense(): Expense = Expense(
        ...
        amount = Money(this[ExpensesTable.amount]),
        vatAmount = this[ExpensesTable.vatAmount]?.let { Money(it) },
        ...
        deductiblePercentage = Percentage(this[ExpensesTable.deductiblePercentage]),
