...
class InvoiceNumberGeneratorTest {
    ...
    private fun createMockRepository(): ai.dokus.foundation.database.repository.cashflow.InvoiceNumberRepository {
        // Create a real repository instance - we won't use its methods
        // in these unit tests (only pure functions are tested)
        return ai.dokus.foundation.database.repository.cashflow.InvoiceNumberRepository()
    }
