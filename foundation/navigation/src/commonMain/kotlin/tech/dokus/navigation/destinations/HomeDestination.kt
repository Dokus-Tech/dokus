...
sealed interface HomeDestination : NavigationDestination {
    ...
    @Serializable
    @SerialName("banking/balances")
    data object Balances : HomeDestination

    @Serializable
    @SerialName("banking/payments")
    data object Payments : HomeDestination
...
val NavigationDestination.route: String get() = when (this) {
    is HomeDestination -> when (this) {
        ...
        HomeDestination.Balances -> "banking/balances"
        HomeDestination.Payments -> "banking/payments"
    ...
    is CashFlowDestination -> when (this) {
        ...
        is CashFlowDestination.DocumentDetail -> "cashflow/document_detail"
