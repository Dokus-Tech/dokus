...
import ai.dokus.app.app.home.screen.HomeScreen
import ai.dokus.app.app.home.splash.SplashScreen
import ai.dokus.app.app.inventory.screen.InventoryScreen
import ai.dokus.app.app.onboarding.authentication.login.LoginScreen
import ai.dokus.app.app.onboarding.authentication.register.RegisterConfirmationScreen
import ai.dokus.app.app.onboarding.authentication.register.RegisterScreen
import ai.dokus.app.app.onboarding.authentication.restore.ForgotPasswordScreen
import ai.dokus.app.app.onboarding.authentication.restore.NewPasswordScreen
import ai.dokus.app.app.onboarding.server.ServerConnectionScreen
import ai.dokus.app.app.onboarding.workspaces.create.WorkspaceCreateScreen
import ai.dokus.app.app.onboarding.workspaces.overview.WorkspacesScreen
