...
group = "ai.dokus.peppol"
version = "1.0.0"

application {
    mainClass.set("ai.dokus.peppol.backend.ApplicationKt")
}
...
dependencies {
    ...
    // Ktor Client (for Recommand API communication)
...
tasks.shadowJar {
    manifest {
        attributes["Main-Class"] = "ai.dokus.peppol.backend.ApplicationKt"
    }
    mergeServiceFiles()
