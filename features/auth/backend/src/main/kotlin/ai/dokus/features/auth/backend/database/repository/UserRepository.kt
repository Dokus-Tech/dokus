...
import ai.dokus.features.auth.backend.database.entity.User
...
import ai.dokus.features.auth.domain.model.Email
import ai.dokus.features.auth.domain.model.UserRole
import ai.dokus.features.auth.domain.model.UserSearchCriteria
import ai.dokus.features.auth.domain.model.UserStatus
