package ai.dokus.features.auth.backend
...
import ai.dokus.features.auth.backend.config.configureAuthentication
import ai.dokus.features.auth.backend.config.configureDependencyInjection
import ai.dokus.features.auth.backend.database.tables.UserLoginAttemptsTable
import ai.dokus.features.auth.backend.database.tables.UserPermissionsTable
import ai.dokus.features.auth.backend.database.tables.UserRolesTable
import ai.dokus.features.auth.backend.database.tables.UserSessionsTable
import ai.dokus.features.auth.backend.database.tables.UserSpecializationsTable
import ai.dokus.features.auth.backend.database.tables.UsersTable
import ai.dokus.features.auth.backend.routes.identityRoutes
import ai.dokus.features.auth.backend.routes.passwordlessAuthRoutes
import ai.dokus.features.auth.backend.routes.userRoutes
