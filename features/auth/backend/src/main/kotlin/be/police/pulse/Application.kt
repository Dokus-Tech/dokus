...
import be.police.pulse.config.configureAuthentication
import be.police.pulse.config.configureDependencyInjection
import be.police.pulse.database.tables.UserLoginAttemptsTable
import be.police.pulse.database.tables.UserPermissionsTable
import be.police.pulse.database.tables.UserRolesTable
import be.police.pulse.database.tables.UserSessionsTable
import be.police.pulse.database.tables.UserSpecializationsTable
import be.police.pulse.database.tables.UsersTable
import be.police.pulse.routes.identityRoutes
import be.police.pulse.routes.passwordlessAuthRoutes
import be.police.pulse.routes.userRoutes
