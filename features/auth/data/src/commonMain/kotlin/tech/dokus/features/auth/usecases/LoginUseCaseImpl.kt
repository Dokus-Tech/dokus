...
class LoginUseCaseImpl(
    ...
    private val logger = Logger.forClass<LoginUseCaseImpl>()
     ...
     */
    override suspend operator fun invoke(email: Email, password: Password): Result<Unit> {
        ...
        // Perform login
        return authGateway.login(request)
    }
}
