...
class ConnectToServerUseCaseImpl(
     ...
     */
    override suspend fun validateAndPreview(config: ServerConfig): Result<ServerInfo> {
     ...
     */
    override suspend fun confirmAndConnect(config: ServerConfig, serverInfo: ServerInfo) {
     ...
     */
    override suspend fun resetToCloud(): Result<ServerInfo> {
