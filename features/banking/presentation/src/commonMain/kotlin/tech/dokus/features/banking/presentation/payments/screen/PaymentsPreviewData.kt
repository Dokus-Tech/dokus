...
private val PreviewTransactions: List<BankTransactionDto> = listOf(
    BankTransactionDto(
        ...
        signedAmount = Money.parseOrThrow("-1250.00", Currency.Eur),
    ...
    BankTransactionDto(
        ...
        signedAmount = Money.parseOrThrow("3500.00", Currency.Eur),
        counterparty = CounterpartySnapshotDto(
            name = "Acme Corp",
    ...
    BankTransactionDto(
        ...
        signedAmount = Money.parseOrThrow("-89.99", Currency.Eur),
    ...
    BankTransactionDto(
        ...
        signedAmount = Money.parseOrThrow("-42.50", Currency.Eur),
        counterparty = CounterpartySnapshotDto(
            name = "Proximus",
    ...
    BankTransactionDto(
        ...
        signedAmount = Money.parseOrThrow("7200.00", Currency.Eur),
        counterparty = CounterpartySnapshotDto(
    ...
    BankTransactionDto(
        ...
        signedAmount = Money.parseOrThrow("-320.00", Currency.Eur),
