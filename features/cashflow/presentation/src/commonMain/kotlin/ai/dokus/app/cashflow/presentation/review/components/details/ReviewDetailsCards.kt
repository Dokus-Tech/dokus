package ai.dokus.app.cashflow.presentation.review.components.details

import ai.dokus.app.cashflow.presentation.review.BillField
...
import ai.dokus.app.cashflow.presentation.review.ExpenseField
import ai.dokus.app.cashflow.presentation.review.InvoiceField
...
import ai.dokus.app.cashflow.presentation.review.components.forms.DetailBlock
import ai.dokus.app.cashflow.presentation.review.components.forms.DetailRow
...
internal fun CounterpartyCard(
    ...
    val counterparty = ai.dokus.app.cashflow.presentation.review.models.counterpartyInfo(state)
        ...
        Column(
            ...
            when (state.editableData.documentType) {
                DocumentType.Invoice -> {
                    val fields = state.editableData.invoice ?: ai.dokus.app.cashflow.presentation.review.EditableInvoiceFields()
                    PTextFieldStandard(
                ...
                DocumentType.Bill -> {
                    val fields = state.editableData.bill ?: ai.dokus.app.cashflow.presentation.review.EditableBillFields()
                    PTextFieldStandard(
                        fieldName = stringResource(Res.string.cashflow_invoice_number),
                        value = fields.invoiceNumber,
                        onValueChange = {
                ...
                DocumentType.Expense -> {
                    val fields = state.editableData.expense ?: ai.dokus.app.cashflow.presentation.review.EditableExpenseFields()
                    PTextFieldStandard(
