...
import tech.dokus.features.cashflow.presentation.detail.ScanningLineOverlay
import tech.dokus.features.cashflow.presentation.detail.components.AnalysisFailedBanner
import tech.dokus.features.cashflow.presentation.detail.components.details.AmountsCard
import tech.dokus.features.cashflow.presentation.detail.components.details.CounterpartyCard
import tech.dokus.features.cashflow.presentation.detail.components.details.DocumentDetailsCard
import tech.dokus.features.cashflow.presentation.detail.components.details.UnknownDocumentDetailsCard
import tech.dokus.features.cashflow.presentation.detail.models.DocumentUiData
import tech.dokus.features.cashflow.presentation.detail.components.details.PeppolStatusCard
import tech.dokus.features.cashflow.presentation.detail.components.details.SourcesCard
    ...
    Column(
            ...
            AnalysisFailedBanner(
                ...
                onRetry = {
                    if (!isAccountantReadOnly) {
                        onIntent(DocumentDetailIntent.RetryAnalysis)
                    }
                },
                onContinueManually = { onIntent(DocumentDetailIntent.DismissFailureBanner) },
                modifier = Modifier.fillMaxWidth(),
            )
        }
        ...
        if (uiData != null) {
            DocumentDetailsCard(
                ...
                onDirectionSelected = { onIntent(DocumentDetailIntent.SelectDirection(it)) },
                modifier = Modifier.fillMaxWidth(),
            )
        } else {
        ...
        SourcesCard(
            ...
            onResolveSame = {
                if (!isAccountantReadOnly) {
                    onIntent(DocumentDetailIntent.ResolvePossibleMatchSame)
                }
            },
            onResolveDifferent = {
                if (!isAccountantReadOnly) {
                    onIntent(DocumentDetailIntent.ResolvePossibleMatchDifferent)
                }
            },
            modifier = Modifier.fillMaxWidth()
        )
