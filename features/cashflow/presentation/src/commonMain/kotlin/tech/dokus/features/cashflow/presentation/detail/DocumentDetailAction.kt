...
sealed interface DocumentDetailAction : MVIAction {
    ...
    data class ShowError(val error: DokusException) : DocumentDetailAction
    data class ShowSuccess(val success: DocumentDetailSuccess) : DocumentDetailAction
}

@Immutable
sealed interface DocumentDetailSuccess {
    data object DocumentConfirmed : DocumentDetailSuccess
}
