            ...
            if (!isAccountantReadOnly) {
                Row(
                    ...
                    POutlinedButton(
                        ...
                        onClick = { onIntent(DocumentDetailIntent.SelectDocumentType(DocumentType.Invoice)) },
                    )
                }
                Row(
                    modifier = Modifier
                    ...
                    POutlinedButton(
                        ...
                        modifier = Modifier.weight(1f),
                        onClick = { onIntent(DocumentDetailIntent.SelectDocumentType(DocumentType.Receipt)) },
                    )
                    POutlinedButton(
                        text = stringResource(Res.string.document_type_credit_note),
                        modifier = Modifier.weight(1f),
                        onClick = { onIntent(DocumentDetailIntent.SelectDocumentType(DocumentType.CreditNote)) },
                    )
                }
            }
        }
