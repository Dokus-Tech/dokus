...
import tech.dokus.features.cashflow.presentation.detail.compressedStatusDetailLocalized
...
import tech.dokus.features.cashflow.presentation.detail.components.details.ClassifiedOnlyDetailsCard
    ...
    Column(
        ...
        if (supportsManualConfirm && !isAccountantReadOnly &&
            ...
            PButton(
                ...
                modifier = Modifier.fillMaxWidth(),
                onClick = { onIntent(DocumentDetailIntent.Confirm) },
            )
            ...
            PButton(
                ...
                modifier = Modifier.fillMaxWidth(),
                onClick = { onIntent(DocumentDetailIntent.Payment(DocumentPaymentIntent.OpenPaymentSheet)) },
            )
        }
    }
}
...
private fun CompressedStatusLine(
    ...
    Row(
        ...
        modifier = if (canUnconfirm) {
            Modifier.clickable { onIntent(DocumentDetailIntent.RequestUnconfirm) }
        } else {
            Modifier
        },
    ) {
