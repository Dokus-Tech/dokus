...
fun getSampleFinancialDocuments(): List<DocDto> {
    ...
    return listOf(
        ...
        DocDto.Invoice.Confirmed(
            ...
            issueDate = date,
            dueDate = date,
            subtotalAmount = Money.parseOrThrow("1240.00", Currency.Eur),
            vatAmount = Money.parseOrThrow("260.00", Currency.Eur),
            totalAmount = Money.parseOrThrow("1500.00", Currency.Eur),
        ...
        DocDto.Invoice.Confirmed(
            ...
            vatAmount = Money.parseOrThrow("260.00", Currency.Eur),
            totalAmount = Money.parseOrThrow("1500.00", Currency.Eur),
            paidAmount = Money.parseOrThrow("1500.00", Currency.Eur),
        ...
        DocDto.Invoice.Confirmed(
            ...
            vatAmount = Money.parseOrThrow("260.00", Currency.Eur),
            totalAmount = Money.parseOrThrow("1500.00", Currency.Eur),
            paidAmount = Money.parseOrThrow("750.00", Currency.Eur),
