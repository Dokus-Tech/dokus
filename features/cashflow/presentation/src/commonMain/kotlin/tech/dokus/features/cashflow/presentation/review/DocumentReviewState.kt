...
data class DocumentReviewState(
    ...
    val cashflowEntryState: DokusState<CashflowEntryEntity> = DokusState.idle(),
    ...
    val financialStatus: ReviewFinancialStatus
        get() {
            ...
            val entry = (cashflowEntryState as? DokusState.Success<CashflowEntryEntity>)?.data
    ...
    val canRecordPayment: Boolean
        get() {
            val entry = (cashflowEntryState as? DokusState.Success<CashflowEntryEntity>)?.data ?: return false
