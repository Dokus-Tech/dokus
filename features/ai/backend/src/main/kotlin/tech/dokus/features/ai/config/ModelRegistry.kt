...
object ModelRegistry {
    ...
    private const val CONTEXT_40K = 40_960L
     ...
     */
    fun contextLength(modelId: String) = contextLengths[modelId] ?: CONTEXT_32K

    /**
     * Check if a model has vision capability.
     */
    fun isVisionModel(modelId: String) = modelId.contains("-vl")
}
